package com.tianqi.aitdwallet.widget;
...
public class MyArrowRefreshHeader extends LinearLayout implements IRefreshHeader {
     ...
     * @param attrs
     */
    public MyArrowRefreshHeader(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView();
    }
