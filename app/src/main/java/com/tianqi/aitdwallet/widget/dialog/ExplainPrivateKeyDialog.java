...
public class ExplainPrivateKeyDialog extends Dialog {
    ...
    public ExplainPrivateKeyDialog(@NonNull Activity context, int themeResId) {
        super(context, themeResId);
        View view = View.inflate(context, R.layout.dialog_explain_private_key, null);
        setContentView(view);
