...
public class ForgetPsdNoticeDialog extends Dialog {
    ...
    public ForgetPsdNoticeDialog(@NonNull Activity context, int themeResId) {
        super(context, themeResId);
        View view = View.inflate(context, R.layout.dialog_forget_psd_notice, null);
        setContentView(view);
