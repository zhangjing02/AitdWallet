...
public class ScreenShotNoticeDialog extends Dialog {
    ...
    @BindView(R.id.iv_shot_warning_content3)
    TextView ivShotWarningContent3;
    ...
    public ScreenShotNoticeDialog(@NonNull Activity context, int themeResId) {
        super(context, themeResId);
        View view = View.inflate(context, R.layout.dialog_screen_shot_notice, null);
        setContentView(view);
