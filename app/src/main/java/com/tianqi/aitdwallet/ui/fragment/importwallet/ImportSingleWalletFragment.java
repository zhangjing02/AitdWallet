...
public class ImportSingleWalletFragment extends BaseFragment {
    ...
    private void initRecycleView() {
        ...
        coinInfo4.setCoin_name(Constant.TRANSACTION_COIN_NAME_USDT_OMNI);
        coinInfo4.setResourceId(R.mipmap.ic_circle_usdt_omni);
        mMessageBeans.add(coinInfo4);

        CoinInfo coinInfo3=new CoinInfo();
        coinInfo3.setCoin_name(Constant.TRANSACTION_COIN_NAME_USDT_ERC20);
        coinInfo3.setResourceId(R.mipmap.ic_circle_usdt_erc20);
