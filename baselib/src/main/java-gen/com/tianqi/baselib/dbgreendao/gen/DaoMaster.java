...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void createAllTables(Database db, boolean ifNotExists) {
        CoinInfoDao.createTable(db, ifNotExists);
        CoinRateInfoDao.createTable(db, ifNotExists);
        ContactsInfoDao.createTable(db, ifNotExists);
    ...
    public static void dropAllTables(Database db, boolean ifExists) {
        CoinInfoDao.dropTable(db, ifExists);
        CoinRateInfoDao.dropTable(db, ifExists);
        ContactsInfoDao.dropTable(db, ifExists);
    ...
    public DaoMaster(Database db) {
        ...
        registerDaoClass(CoinInfoDao.class);
        registerDaoClass(CoinRateInfoDao.class);
