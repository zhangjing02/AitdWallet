 ...
 */
public class HttpClientUtil002 {
    ...
    private static HttpClientUtil002 mInstance;
    private OkHttpClient okHttpClient;

    private HttpClientUtil002() {
     ...
     */
    public static HttpClientUtil002 getInstance() {
        if (mInstance == null) {
            synchronized (LOCKER) {
                mInstance = new HttpClientUtil002();
            }
        }
        return mInstance;
    }
     ...
     * @throws IOException 异常
     */
    public String postJson(String url, String json,String username,String password) throws IOException {
...
//        String s = getInstance().postJson("http://192.168.1.99:18443", JSONObject.toJSONString(listunspentParams), "dev", "a");
